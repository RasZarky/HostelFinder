...
import 'package:hostel_finder/modules/hotel_detailes/review_data_view.dart';
...
class HotelDetailes extends StatefulWidget {
  final Map hostelData;

  const HotelDetailes({Key? key, required this.hostelData}) : super(key: key);
  @override
  _HotelDetailesState createState() => _HotelDetailesState(hostelData: hostelData);
}
...
class _HotelDetailesState extends State<HotelDetailes>
  ...
  final Map hostelData;
  _HotelDetailesState( {required this.hostelData});

  ScrollController scrollController = ScrollController(initialScrollOffset: 0);
  var hoteltext1 =
      "Featuring a fitness center, Grand Hostel is located in Kumasi, 4.7 km frome National Museum...";
  var hoteltext2 =
      "Featuring a fitness center, Grand Hostel is located in Kumasi, 4.7 km frome National Museum a fitness center, Grand Royale Park Hote is located in Sweden, 4.7 km frome National Museum a fitness center, Grand Royale Park Hote is located in Sweden, 4.7 km frome National Museum";
  bool isFav = false;
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          CommonCard(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: !isReadless ? hostelData['description'] : hostelData['description']+hoteltext2,
                ...
                // ),
                _getPhotoReviewUi(
                    "room_photo", '', Icons.arrow_forward, () {}),
                  ...
                  child: CommonButton(
                    ...
                    onTap: () {
                      NavigationServices(context)
                          .gotoRoomBookingScreen(hostelData['name']);
                    },
                  ),
                ),
          ...
          _backgraoundImageUI(hostelData),
  ...
  Widget _backgraoundImageUI(Map hostelData) {
    return Positioned(
      top: 0,
      left: 0,
      right: 0,
